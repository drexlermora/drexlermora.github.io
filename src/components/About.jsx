...
const intro = `I am a software engineer with 8 years of experience, including nearly 6 years in Japan and 2 years in the Philippines.`;
...
const About = () => {
  ...
  useEffect(() => {
    const delay = intro.length * 5 + 1000;
    const timer = setTimeout(() => setShowRest(true), delay);
  ...
  return (
    <section id="about" className="about-section text-center py-12">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        {showRest && remainingParagraphs.map((paragraph, index) => (
          <motion.p
            key={index}
