...
const Skills = () => {
  const skills = [
    ...
    { title: "Apache Wicket", imageSrc : "/assets/skills/wicket-logo.png", text: "I have experience and expertise in using Apache Wicket to develop robust web applications. I am familiar with the key concepts and components of the framework, such as how to structure and manage web pages with Wicket's component-based architecture. I am skilled in creating dynamic UIs, handling user interactions, and efficiently managing backend data binding through Wicket’s model system." },
