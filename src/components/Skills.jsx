...
const Skills = () => {
  const skills = [
    ...
    { title: "Node", imageSrc : "/assets/skills/nodejs.png", text: "I have a solid understanding of Node.js and its core concepts. I am proficient in using it to build scalable and efficient server-side applications, utilizing its asynchronous event-driven architecture. With experience in handling tasks like managing APIs, working with databases, and implementing middleware, I am comfortable leveraging Node.js to create robust back-end solutions." },
    { title: "Vite", imageSrc : "/assets/skills/vite.png", text: "I am proficient in using Vite, a modern, fast, and highly efficient build tool for front-end development. I have experience leveraging its capabilities to improve development workflows, utilizing features like instant hot module replacement (HMR), optimized builds, and support for a wide range of front-end frameworks like React, Vue, and Svelte. With Vite, I am able to streamline project setups, enhance performance, and ensure a smooth development experience by taking advantage of its lightning-fast bundling and real-time feedback during code changes." },
    ...
    { title: "JQuery", imageSrc : "/assets/skills/jquery.png", text: "I have extensive experience using jQuery, a fast and lightweight JavaScript library, to enhance user interactions and simplify DOM manipulation. I am skilled in utilizing jQuery to create dynamic, responsive web pages, enabling smooth animations, event handling, and AJAX requests. With jQuery, I can efficiently handle cross-browser compatibility issues, streamline UI enhancements, and optimize performance, ensuring a seamless experience across different platforms and devices." },
